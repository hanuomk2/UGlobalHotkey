...
UKeySequence::UKeySequence(QString const &str, QObject *parent)
	: QObject(parent)
{
	FromString(str);
}
...
void UKeySequence::FromString(QString const &str)
{
...
void UKeySequence::AddKey(QString const &key)
{
...
void UKeySequence::AddKey(QKeyEvent const *event)
{
	AddKey(event->key());
